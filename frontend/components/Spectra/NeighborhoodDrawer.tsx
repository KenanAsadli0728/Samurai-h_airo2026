...
import { ChevronUp, ChevronDown, ArrowUpDown, ShieldAlert } from 'lucide-react'
    ...
    >
      ...
      <div className="overflow-y-auto" style={{ maxHeight: '212px' }}>
        ...
        {sorted.map(n => (
          ...
          >
            <span className="flex-1 min-w-0 flex items-center gap-1.5 text-xs text-white font-plex truncate">
              {n.grid_blind_spot_score >= 40 && (
